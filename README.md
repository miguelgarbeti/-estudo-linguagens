...
| :--- | :--- |
| **C** | Desenvolvimento de sistemas de baixo nível, sistemas operacionais e software de alto desempenho |
| **C++** | Desenvolvimento de sistemas de alta performance, softwares de infraestrutura e aplicações que exigem manipulação direta de hardware e memória |
| **Rust** | Desenvolvimento de sistemas de alta performance e seguros |
...
| Linguagem | Descrição |
| :--- | :--- |
| **Python** | Inteligência Artificial (IA): É a linguagem líder no desenvolvimento de IA, impulsionando o treinamento de modelos com bibliotecas como TensorFlow |
...
2. **Kotlin** ( Ele é moderno, conciso e totalmente interoperável com Java, permitindo que ambos coexistam no mesmo projeto Android)
3. **C#**  ( É uma plataforma open-source para criar aplicações web, desktop, mobile com cossistema .NET)
4. **TypeScript** (*É um superset de JavaScript com tipagem estática. Como navegadores e Node*)
